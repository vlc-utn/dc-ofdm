...
xlabel("Tiempo $[\mu s]$", FontSize=fsize, Interpreter="latex");
ylabel('$x[n \cdot M]$', FontSize=fsize, Interpreter="latex");
...
plot(f, 10*log10(psd), LineWidth=2);
xlabel('Frecuencia $[MHz]$', FontSize=fsize, Interpreter="latex");
ylabel('PSD\{$x[n \cdot M]$\}  $[\frac{dB}{MHz}]$', FontSize=fsize, Interpreter="latex");
...
xlabel('Tiempo $[\mu s]$', FontSize=fsize, Interpreter="latex");
ylabel("LPF $\{x[n]\} [n \cdot M]$", FontSize=fsize, Interpreter="latex");
...
plot(f, 10*log10(psd), LineWidth=2);
xlabel('Frecuencia $[MHz]$', FontSize=fsize, Interpreter="latex");
ylabel('PSD $\{\textrm{LPF} \{x[n]\} [n \cdot M] \}$  $[\frac{dB}{MHz}]$', FontSize=fsize, Interpreter="latex");
