...
BEGIN
  ...
  tmp <= obj_samplesRepetitionObj_FFTLenReg WHEN reset = '0' ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_FFTLenReg_2 <= tmp;
      END IF;
    END IF;
  ...
  tmp_1 <= varargout_2_1 WHEN reset = '0' ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_ctrl_1 <= tmp_3;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_currFFTLength_1 <= tmp_7;
      END IF;
    END IF;
  ...
  tmp_6 <= obj_samplesRepetitionObj_currFFTLength_1 WHEN s_1 = '0' ELSE
      tmp_4;

  
  a0 <= '1' WHEN obj_samplesRepetitionObj_inCount_2 = tmp_6 ELSE
      '0';

  
  tmp_8 <= tmp_5 WHEN a0 = '0' ELSE
      obj_samplesRepetitionObj_inCount;

  
  tmp_9 <= obj_samplesRepetitionObj_inCount_2 WHEN obj_samplesRepetitionObj_validInReg_1 = '0' ELSE
      tmp_8;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_inCount_2 <= tmp_10;
      END IF;
    END IF;
  ...
  tmp_11 <= obj_samplesRepetitionObj_flag_3 WHEN a0_2 = '0' ELSE
      obj_samplesRepetitionObj_flag_1;

  
  tmp_12 <= obj_samplesRepetitionObj_flag_3 WHEN tmp_2 = '0' ELSE
      tmp_11;

  
  tmp_13 <= obj_samplesRepetitionObj_flag_3 WHEN a0_1 = '0' ELSE
      obj_samplesRepetitionObj_flag;

  
  tmp_14 <= obj_samplesRepetitionObj_flag_3 WHEN tmp_2 = '0' ELSE
      tmp_13;

  
  tmp_15 <= tmp_14 WHEN obj_samplesRepetitionObj_flag_3 = '0' ELSE
      tmp_12;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_flag_3 <= tmp_16;
      END IF;
    END IF;
  ...
  tmp_18 <= obj_samplesRepetitionObj_startRead1_1 WHEN tmp_17 = '0' ELSE
  ...
  tmp_20 <= obj_samplesRepetitionObj_startRead1_4 WHEN s_3 = '0' ELSE
      tmp_19;

  
  tmp_22 <= tmp_21 WHEN a0_1 = '0' ELSE
  ...
  tmp_24 <= tmp_23 WHEN s_2 = '0' ELSE
      obj_samplesRepetitionObj_outCount_1;

  tmp_25 <= obj_samplesRepetitionObj_outCount_3 + to_unsigned(16#001#, 9);
  ...
  tmp_27 <= obj_samplesRepetitionObj_outCount_3 WHEN s_5 = '0' ELSE
      tmp_26;

  
  tmp_28 <= tmp_27 WHEN s_3 = '0' ELSE
      tmp_24;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_outCount_3 <= tmp_29;
      END IF;
    END IF;
  ...
  tmp_31 <= obj_samplesRepetitionObj_startRead2_4 WHEN s_5 = '0' ELSE
      tmp_30;

  
  tmp_33 <= obj_samplesRepetitionObj_startRead2 WHEN tmp_32 = '0' ELSE
      obj_samplesRepetitionObj_startRead2_1;

  
  tmp_35 <= tmp_34 WHEN a0_2 = '0' ELSE
      obj_samplesRepetitionObj_sym2Done_1;

  
  tmp_36 <= tmp_34 WHEN tmp_2 = '0' ELSE
      tmp_35;

  
  tmp_37 <= obj_samplesRepetitionObj_sym2Done WHEN tmp_32 = '0' ELSE
      obj_samplesRepetitionObj_sym2Done_3;

  
  tmp_34 <= obj_samplesRepetitionObj_sym2Done_3 WHEN obj_samplesRepetitionObj_sym2Done_3 = '0' ELSE
      tmp_37;

  
  tmp_38 <= tmp_34 WHEN obj_samplesRepetitionObj_flag_3 = '0' ELSE
      tmp_36;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_sym2Done_3 <= tmp_39;
      END IF;
    END IF;
  ...
  tmp_40 <= tmp_17 WHEN obj_samplesRepetitionObj_sym2Done_3 = '0' ELSE
      tmp_33;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_startRead2_4 <= tmp_41;
      END IF;
    END IF;
  ...
  tmp_17 <= tmp_31 WHEN s_3 = '0' ELSE
      obj_samplesRepetitionObj_startRead2_4;

  
  tmp_42 <= obj_samplesRepetitionObj_sym1Done WHEN tmp_17 = '0' ELSE
      obj_samplesRepetitionObj_sym1Done_3;

  
  tmp_21 <= obj_samplesRepetitionObj_sym1Done_3 WHEN obj_samplesRepetitionObj_sym1Done_3 = '0' ELSE
      tmp_42;

  
  tmp_43 <= tmp_21 WHEN tmp_2 = '0' ELSE
      tmp_22;

  
  tmp_44 <= tmp_43 WHEN obj_samplesRepetitionObj_flag_3 = '0' ELSE
      tmp_21;

  
  tmp_45 <= tmp_44 WHEN reset = '0' ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_sym1Done_3 <= tmp_45;
      END IF;
    END IF;
  ...
  tmp_32 <= tmp_20 WHEN obj_samplesRepetitionObj_sym1Done_3 = '0' ELSE
      tmp_18;

  
  tmp_46 <= tmp_32 WHEN reset = '0' ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_startRead1_4 <= tmp_46;
      END IF;
    END IF;
  ...
  tmp_47 <= obj_samplesRepetitionObj_startRead1_4 WHEN reset = '0' ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_strtRd1Reg_1 <= tmp_47;
      END IF;
    END IF;
  ...
  tmp_48 <= obj_samplesRepetitionObj_strtRd1Reg_1 WHEN reset = '0' ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_strtRd1Reg1_1 <= tmp_48;
      END IF;
    END IF;
  ...
  tmp_49 <= obj_samplesRepetitionObj_startRead2_4 WHEN reset = '0' ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_strtRd2Reg_1 <= tmp_49;
      END IF;
    END IF;
  ...
  tmp_50 <= obj_samplesRepetitionObj_strtRd2Reg_1 WHEN reset = '0' ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_strtRd2Reg1_1 <= tmp_50;
      END IF;
    END IF;
  ...
  tmp_51 <= obj_samplesRepetitionObj_wrAddr2_2 + to_unsigned(16#001#, 10);

  
  tmp_52 <= tmp_51 WHEN a0_2 = '0' ELSE
      obj_samplesRepetitionObj_wrAddr2;

  
  tmp_53 <= obj_samplesRepetitionObj_wrAddr2_2 WHEN tmp_2 = '0' ELSE
      tmp_52;

  
  tmp_54 <= obj_samplesRepetitionObj_wrAddr2_2 WHEN obj_samplesRepetitionObj_flag_3 = '0' ELSE
      tmp_53;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_wrAddr2_2 <= tmp_55;
      END IF;
    END IF;
  ...
  tmp_56 <= out_rsvd WHEN s_8 = '0' ELSE
      out_rsvd_1;

  obj_samplesRepetitionObj_wrEn2 <= '0';

  
  tmp_57 <= obj_samplesRepetitionObj_wrEn2_1 WHEN s = '0' ELSE
      tmp_56;

  
  tmp_58 <= tmp_57 WHEN reset = '0' ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_wrEn2_1 <= tmp_58;
      END IF;
    END IF;
  ...
  tmp_59 <= '1' WHEN tmp_28 = to_unsigned(16#000#, 9) ELSE
      '0';

  obj_samplesRepetitionObj_prevFFTLength <= to_unsigned(16#100#, 9);

  
  tmp_60 <= obj_samplesRepetitionObj_prevFFTLength_1 WHEN tmp_59 = '0' ELSE
      obj_samplesRepetitionObj_currFFTLength_1;

  
  tmp_61 <= obj_samplesRepetitionObj_prevFFTLength_1 WHEN s_9 = '0' ELSE
      tmp_60;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_prevFFTLength_1 <= tmp_62;
      END IF;
    END IF;
  ...
  tmp_64 <= tmp_63 WHEN tmp_59 = '0' ELSE
      obj_samplesRepetitionObj_rdAddr2_1;

  tmp_65 <= obj_samplesRepetitionObj_rdAddr2_3 + to_unsigned(16#001#, 10);
  ...
  tmp_66 <= tmp_65 WHEN s_10 = '0' ELSE
      obj_samplesRepetitionObj_rdAddr2;

  
  tmp_67 <= obj_samplesRepetitionObj_rdAddr2_3 WHEN s_5 = '0' ELSE
      tmp_66;

  
  tmp_63 <= tmp_67 WHEN s_3 = '0' ELSE
      obj_samplesRepetitionObj_rdAddr2_3;

  
  tmp_68 <= tmp_63 WHEN s_9 = '0' ELSE
      tmp_64;

  
  tmp_69 <= tmp_68 WHEN reset = '0' ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_rdAddr2_3 <= tmp_69;
      END IF;
    END IF;
  ...
  tmp_70 <= obj_samplesRepetitionObj_wrAddr1_2 + to_unsigned(16#001#, 10);

  
  tmp_71 <= tmp_70 WHEN a0_1 = '0' ELSE
      obj_samplesRepetitionObj_wrAddr1;

  
  tmp_72 <= obj_samplesRepetitionObj_wrAddr1_2 WHEN tmp_2 = '0' ELSE
      tmp_71;

  
  tmp_73 <= tmp_72 WHEN obj_samplesRepetitionObj_flag_3 = '0' ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_wrAddr1_2 <= tmp_74;
      END IF;
    END IF;
  ...
  tmp_75 <= out_rsvd_2 WHEN s_11 = '0' ELSE
      out_rsvd_3;

  obj_samplesRepetitionObj_wrEn1 <= '0';

  
  tmp_76 <= obj_samplesRepetitionObj_wrEn1_1 WHEN s = '0' ELSE
      tmp_75;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_wrEn1_1 <= tmp_77;
      END IF;
    END IF;
  ...
  tmp_79 <= tmp_78 WHEN tmp_59 = '0' ELSE
      obj_samplesRepetitionObj_rdAddr1_1;

  tmp_80 <= obj_samplesRepetitionObj_rdAddr1_3 + to_unsigned(16#001#, 10);
  ...
  tmp_81 <= tmp_80 WHEN s_12 = '0' ELSE
      obj_samplesRepetitionObj_rdAddr1;

  
  tmp_78 <= obj_samplesRepetitionObj_rdAddr1_3 WHEN s_3 = '0' ELSE
      tmp_81;

  
  tmp_82 <= tmp_78 WHEN s_9 = '0' ELSE
      tmp_79;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_rdAddr1_3 <= tmp_83;
      END IF;
    END IF;
  ...
  tmp_84 <= obj_samplesRepetitionObj_validOutReg WHEN s_5 = '0' ELSE
      obj_samplesRepetitionObj_validOutReg_1;

  obj_samplesRepetitionObj_validOutReg_2 <= '1';

  
  tmp_85 <= tmp_84 WHEN s_3 = '0' ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_validOutReg_4 <= tmp_86;
      END IF;
    END IF;
  ...
  tmp_87 <= obj_samplesRepetitionObj_validOutReg_4 WHEN reset = '0' ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_validOutReg1_1 <= tmp_87;
      END IF;
    END IF;
  ...
  tmp_88 <= obj_samplesRepetitionObj_validOutReg1_1 WHEN reset = '0' ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_validOutReg2_1 <= tmp_88;
      END IF;
    END IF;
  ...
  tmp_89 <= obj_samplesRepetitionObj_validOutReg2_1 WHEN reset = '0' ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_validOut_1 <= tmp_89;
      END IF;
    END IF;
  ...
  tmp_90 <= obj_samplesRepetitionObj_FFTLengthReg_1 WHEN s_1 = '0' ELSE
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_FFTLengthReg_1 <= tmp_91;
      END IF;
    END IF;
  ...
  tmp_92 <= obj_samplesRepetitionObj_FFTLengthRegOut_1 WHEN tmp_59 = '0' ELSE
      obj_samplesRepetitionObj_FFTLengthReg_1;

  
  tmp_93 <= obj_samplesRepetitionObj_FFTLengthRegOut_1 WHEN s_9 = '0' ELSE
      tmp_92;

  
  tmp_94 <= tmp_93 WHEN reset = '0' ELSE
  ...
  tmp_95 <= varargin_4_unsigned(8 DOWNTO 0);

  obj_samplesRepetitionObj_CPLengthReg <= to_unsigned(16#010#, 9);

  
  tmp_96 <= obj_samplesRepetitionObj_CPLengthReg_1 WHEN s_1 = '0' ELSE
      tmp_95;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_CPLengthReg_1 <= tmp_97;
      END IF;
    END IF;
  ...
  tmp_98 <= obj_samplesRepetitionObj_CPLengthRegOut_1 WHEN tmp_59 = '0' ELSE
      obj_samplesRepetitionObj_CPLengthReg_1;

  
  tmp_99 <= obj_samplesRepetitionObj_CPLengthRegOut_1 WHEN s_9 = '0' ELSE
      tmp_98;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        obj_samplesRepetitionObj_CPLengthRegOut_1 <= tmp_100;
      END IF;
    END IF;
