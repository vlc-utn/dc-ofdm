...
ARCHITECTURE rtl OF IEEE_8021513_TX_src_Mixer IS
  ...
  SIGNAL Multiply_by_two_out1_re          : signed(19 DOWNTO 0);  -- sfix20_En16
  SIGNAL Multiply_by_two_out1_im          : signed(19 DOWNTO 0);  -- sfix20_En16
...
BEGIN
  ...
  Multiply_by_two_out1_re <= Delay8_out1_re sll 1;
  Multiply_by_two_out1_im <= Delay8_out1_im sll 1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_gated_4 = '1' THEN
        Delay_reg_im(0) <= Multiply_by_two_out1_im;
        Delay_reg_im(1) <= Delay_reg_im(0);
        Delay_reg_re(0) <= Multiply_by_two_out1_re;
