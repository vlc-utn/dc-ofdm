...
ARCHITECTURE rtl OF IEEE_8021513_TX_src_FIR_Interpolator IS
  ...
  SIGNAL intdelay_reg                     : std_logic_vector(4 DOWNTO 0);  -- ufix1 [5]
  ...
  SIGNAL intdelay_reg_re                  : vector_of_signed20(0 TO 4);  -- sfix20_En16 [5]
  SIGNAL intdelay_reg_im                  : vector_of_signed20(0 TO 4);  -- sfix20_En16 [5]
    ...
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        ELSE 
          ...
          intdelay_reg(4 DOWNTO 1) <= intdelay_reg(3 DOWNTO 0);
        END IF;
      END IF;
    END IF;
  END PROCESS intdelay_process;

  ValidPipeline1 <= intdelay_reg(4);
    ...
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        ELSE 
          ...
          intdelay_reg_im(1 TO 4) <= intdelay_reg_im(0 TO 3);
          intdelay_reg_re(0) <= FIROutput1_re_signed;
          intdelay_reg_re(1 TO 4) <= intdelay_reg_re(0 TO 3);
        END IF;
      END IF;
    END IF;
  END PROCESS intdelay_1_process;

  FIROutputCastDBP1_re <= intdelay_reg_re(4);
  FIROutputCastDBP1_im <= intdelay_reg_im(4);
