...
ARCHITECTURE rtl OF IEEE_8021513_TX_src_payload_full IS
  ...
  SIGNAL psdu_size_to_payload_length_out1 : std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  SIGNAL batid_to_bits_per_subcarrier_out1_unsigned : unsigned(3 DOWNTO 0);  -- ufix4
  SIGNAL bits_per_subcarrier_1            : unsigned(3 DOWNTO 0);  -- ufix4
  SIGNAL Delay6_out1                      : unsigned(3 DOWNTO 0);  -- ufix4
  SIGNAL psdu_size_to_payload_length_out1_unsigned : unsigned(15 DOWNTO 0);  -- uint16
...
BEGIN
  ...
  u_psdu_size_to_payload_length : IEEE_8021513_TX_src_psdu_size_to_payload_length
    PORT MAP( clk => clk,
              ...
              payload_len_in_ofdm_symbols => psdu_size_to_payload_length_out1,  -- uint16
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay9_out1 <= Rate_Transition1_out1;
      END IF;
    END IF;
  ...
  batid_to_bits_per_subcarrier_out1_unsigned <= unsigned(batid_to_bits_per_subcarrier_out1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_8_0 = '1' THEN
        bits_per_subcarrier_1 <= batid_to_bits_per_subcarrier_out1_unsigned;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay6_out1 <= bits_per_subcarrier_1;
      END IF;
    END IF;
  END PROCESS Delay6_process;


  psdu_size_to_payload_length_out1_unsigned <= unsigned(psdu_size_to_payload_length_out1);

  Rate_Transition5_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        len_in_ofdm_symbols_1 <= to_unsigned(16#0000#, 16);
      ELSIF enb_1_8_0 = '1' THEN
        len_in_ofdm_symbols_1 <= psdu_size_to_payload_length_out1_unsigned;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay10_out1 <= len_in_ofdm_symbols_1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay11_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay11_out1 <= Rate_Transition6_out1;
      END IF;
    END IF;
