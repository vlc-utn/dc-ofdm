...
BEGIN
  ...
  embreciprocals_c21_sLIr8j5GqJp0mDWGPVD1npB_normalizedCORDICDivi_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      END IF;
    END IF;
  END PROCESS embreciprocals_c21_sLIr8j5GqJp0mDWGPVD1npB_normalizedCORDICDivi_process;

  embreciprocals_c21_sLIr8j5GqJp0mDWGPVD1npB_normalizedCORDICDivi_output : PROCESS (den_signed, isDenNegative, isDenZeroReg, isNegativeReg, isNumNegative,
  ...
  END PROCESS embreciprocals_c21_sLIr8j5GqJp0mDWGPVD1npB_normalizedCORDICDivi_output;
