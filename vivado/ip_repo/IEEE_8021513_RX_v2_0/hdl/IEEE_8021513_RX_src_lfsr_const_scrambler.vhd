-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLRx/IEEE_8021513_RX_src_lfsr_const_scrambler.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_RX_src_lfsr_const_scrambler
-- Source Path: HDLRx/full_rx/rx_demodulator_full/constellation_descrambler/lfsr_const_scrambler
-- Hierarchy Level: 3
-- Model version: 1.147
-- 
-- -------------------------------------------------------------
...
ENTITY IEEE_8021513_RX_src_lfsr_const_scrambler IS
...
END IEEE_8021513_RX_src_lfsr_const_scrambler;


ARCHITECTURE rtl OF IEEE_8021513_RX_src_lfsr_const_scrambler IS

  -- Signals
  SIGNAL descrambler_valid                : std_logic;
  SIGNAL descrambler_valid_1              : std_logic;
  SIGNAL descrambler_valid_2              : std_logic;
  SIGNAL descrambler_valid_3              : std_logic;
  SIGNAL descrambler_valid_4              : std_logic;
  SIGNAL descrambler_valid_5              : std_logic;
  SIGNAL descrambler_valid_6              : std_logic;
  SIGNAL descrambler_valid_7              : std_logic;
  SIGNAL descrambler_valid_8              : std_logic;
  SIGNAL descrambler_valid_9              : std_logic;
  SIGNAL descrambler_valid_10             : std_logic;
  SIGNAL descrambler_valid_11             : std_logic;
  SIGNAL descrambler_valid_12             : std_logic;
...
BEGIN
  descrambler_valid <= valid_in;

  descrambler_valid_1 <= valid_in;

  descrambler_valid_2 <= valid_in;

  descrambler_valid_3 <= valid_in;

  descrambler_valid_4 <= valid_in;

  descrambler_valid_5 <= valid_in;

  descrambler_valid_6 <= valid_in;

  descrambler_valid_7 <= valid_in;

  descrambler_valid_8 <= valid_in;

  descrambler_valid_9 <= valid_in;

  descrambler_valid_10 <= valid_in;

  descrambler_valid_11 <= valid_in;

  descrambler_valid_12 <= valid_in;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay2_out1 <= '0';
      ELSIF enb_1_2_0 = '1' AND descrambler_valid_12 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay4_out1 <= '0';
      ELSIF enb_1_2_0 = '1' AND descrambler_valid_11 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay6_out1 <= '0';
      ELSIF enb_1_2_0 = '1' AND descrambler_valid_10 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay8_out1 <= '0';
      ELSIF enb_1_2_0 = '1' AND descrambler_valid_9 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay10_out1 <= '0';
      ELSIF enb_1_2_0 = '1' AND descrambler_valid_8 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay12_out1 <= '0';
      ELSIF enb_1_2_0 = '1' AND descrambler_valid_7 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        s2 <= '0';
      ELSIF enb_1_2_0 = '1' AND descrambler_valid_6 = '1' THEN
        s2 <= Switch1_out1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay3_out1 <= '0';
      ELSIF enb_1_2_0 = '1' AND descrambler_valid_5 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay5_out1 <= '0';
      ELSIF enb_1_2_0 = '1' AND descrambler_valid_4 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay7_out1 <= '0';
      ELSIF enb_1_2_0 = '1' AND descrambler_valid_3 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay9_out1 <= '0';
      ELSIF enb_1_2_0 = '1' AND descrambler_valid_2 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay11_out1 <= '0';
      ELSIF enb_1_2_0 = '1' AND descrambler_valid_1 = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        s1 <= '0';
      ELSIF enb_1_2_0 = '1' AND descrambler_valid = '1' THEN
        s1 <= Switch_out1;
      END IF;
    END IF;
