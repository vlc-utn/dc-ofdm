...
ARCHITECTURE rtl OF IEEE_8021513_RX_src_ofdm_separator IS
  ...
  COMPONENT IEEE_8021513_RX_src_psdu_size_to_payload_length
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  FOR ALL : IEEE_8021513_RX_src_psdu_size_to_payload_length
    USE ENTITY work.IEEE_8021513_RX_src_psdu_size_to_payload_length(rtl);
...
BEGIN
  ...
  u_psdu_size_to_payload_length : IEEE_8021513_RX_src_psdu_size_to_payload_length
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
  ...
  u_Compare_To_Constant1 : IEEE_8021513_RX_src_Compare_To_Constant1_block
    PORT MAP( u => psdu_size_to_payload_length_out1,  -- uint16
  ...
  payloadNumOFDMSamples <= psdu_size_to_payload_length_out1_unsigned * Delay3_out1;
  ...
  payload_num_ofdm_symbols <= psdu_size_to_payload_length_out1;
