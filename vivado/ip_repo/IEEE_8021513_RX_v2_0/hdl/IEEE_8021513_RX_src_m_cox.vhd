...
ARCHITECTURE rtl OF IEEE_8021513_RX_src_m_cox IS
  ...
  SIGNAL p_pelado_re                      : std_logic_vector(19 DOWNTO 0);  -- ufix20
  SIGNAL p_pelado_im                      : std_logic_vector(19 DOWNTO 0);  -- ufix20
  ...
  SIGNAL p_pelado_re_signed               : signed(19 DOWNTO 0);  -- sfix20_En10
  SIGNAL p_pelado_im_signed               : signed(19 DOWNTO 0);  -- sfix20_En10
...
BEGIN
  ...
  u_calculate_P : IEEE_8021513_RX_src_calculate_P
    PORT MAP( clk => clk,
              ...
              P_d_re => p_pelado_re,  -- sfix20_En10
              P_d_im => p_pelado_im  -- sfix20_En10
              );
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        IF mergedDelay_waddr >= to_unsigned(16#A31#, 12) THEN 
          mergedDelay_waddr <= to_unsigned(16#000#, 12);
        ELSE 
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        IF mergedDelay_raddr >= to_unsigned(16#A31#, 12) THEN 
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        Delay1_reg_im(0) <= p_pelado_im_signed;
        Delay1_reg_im(1 TO 39) <= Delay1_reg_im(0 TO 38);
        Delay1_reg_re(0) <= p_pelado_re_signed;
