...
ARCHITECTURE rtl OF IEEE_8021513_RX_src_full_rx IS
  ...
  SIGNAL Delay18_out1_valid               : std_logic;
  SIGNAL LDPC_shared_out3_start           : std_logic;
  SIGNAL Delay18_out1_start               : std_logic;
  ...
  SIGNAL Delay10_out1                     : std_logic_vector(15 DOWNTO 0);  -- ufix1 [16]
  ...
  SIGNAL Delay9_out1                      : std_logic_vector(23 DOWNTO 0);  -- ufix1 [24]
  ...
  SIGNAL Delay6_out1                      : std_logic_vector(3 DOWNTO 0);  -- ufix1 [4]
  ...
  SIGNAL batid_to_bits_per_subcarrier_out1 : std_logic_vector(3 DOWNTO 0);  -- ufix4
  ...
  SIGNAL Delay19_out1_valid               : std_logic;
  SIGNAL LDPC_shared_out2_end             : std_logic;
  SIGNAL Delay19_out1_end                 : std_logic;
  SIGNAL LDPC_shared_out2_start           : std_logic;
  SIGNAL Delay19_out1_start               : std_logic;
  ...
  SIGNAL Delay13_out1_end                 : std_logic;
  SIGNAL rx_payload_full_out7_start       : std_logic;
  SIGNAL Delay13_out1_start               : std_logic;
  SIGNAL rx_payload_full_out6             : std_logic_vector(3 DOWNTO 0);  -- ufix4
  SIGNAL rx_payload_full_out6_signed      : signed(3 DOWNTO 0);  -- sfix4_En1
  SIGNAL Delay14_out1                     : signed(3 DOWNTO 0);  -- sfix4_En1
  SIGNAL h_rx_full_out15_valid            : std_logic;
  SIGNAL Delay15_out1_valid               : std_logic;
  SIGNAL h_rx_full_out15_end              : std_logic;
  SIGNAL Delay15_out1_end                 : std_logic;
  SIGNAL h_rx_full_out15_start            : std_logic;
  SIGNAL Delay15_out1_start               : std_logic;
  SIGNAL h_rx_full_out14                  : std_logic_vector(3 DOWNTO 0);  -- ufix4
  SIGNAL h_rx_full_out14_signed           : signed(3 DOWNTO 0);  -- sfix4_En1
  SIGNAL Delay16_out1                     : signed(3 DOWNTO 0);  -- sfix4_En1
  ...
  SIGNAL header_clock_x2_out1             : std_logic_vector(3 DOWNTO 0);  -- ufix4
  ...
  SIGNAL prepare_payload_data_out1_signed : signed(3 DOWNTO 0);  -- sfix4_En1
  SIGNAL Delay21_reg                      : vector_of_signed4(0 TO 1);  -- sfix4 [2]
  SIGNAL Delay21_out1                     : signed(3 DOWNTO 0);  -- sfix4_En1
...
BEGIN
  ...
  u_batid_to_bits_per_subcarrier : IEEE_8021513_RX_src_batid_to_bits_per_subcarrier
    PORT MAP( bat_id => h_rx_full_out8,  -- ufix1 [5]
              bits_per_subcarrier => batid_to_bits_per_subcarrier_out1  -- ufix4
              );
  ...
  u_LDPC_shared : IEEE_8021513_RX_src_LDPC_shared
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              ldpc_data_header => std_logic_vector(Delay16_out1),  -- sfix4_En1
              ldpc_ctrl_header_start => Delay15_out1_start,
              ldpc_ctrl_header_end => Delay15_out1_end,
              ldpc_ctrl_header_valid => Delay15_out1_valid,
              ldpc_data_payload => std_logic_vector(Delay14_out1),  -- sfix4_En1
              ldpc_ctrl_payload_start => Delay13_out1_start,
              ldpc_ctrl_payload_end => Delay13_out1_end,
              ldpc_ctrl_payload_valid => Delay13_out1_valid,
              start_header => Delay12_out1,
              end_header => Delay11_out1,
  ...
  u_header_clock_x2 : IEEE_8021513_RX_src_header_clock_x2
    PORT MAP( clk => clk,
              ...
              data_out => header_clock_x2_out1,  -- sfix4_En1
  ...
  u_h_rx_full : IEEE_8021513_RX_src_h_rx_full
    PORT MAP( clk => clk,
              ...
              enb_1_8_0 => enb_1_8_0,
              enb_1_8_1 => enb_1_8_1,
              data_in => header_clock_x2_out1,  -- sfix4_En1
              start_in => header_clock_x2_out2,
              ldpc_in => Delay20_out1,
              ldpc_ctrl_in_start => Delay19_out1_start,
              ldpc_ctrl_in_end => Delay19_out1_end,
              ldpc_ctrl_in_valid => Delay19_out1_valid,
  ...
  u_rx_payload_full : IEEE_8021513_RX_src_rx_payload_full
    PORT MAP( clk => clk,
              ...
              enb_1_8_0 => enb_1_8_0,
              enb_1_8_1 => enb_1_8_1,
              data_in => std_logic_vector(Delay21_out1),  -- sfix4_En1
              valid_in => Delay22_out1,
              new_frame => Delay23_out1,
              scrambler_init => Delay6_out1,  -- ufix1 [4]
              psdu_size => Delay9_out1,  -- ufix1 [24]
              msg_duration => Delay10_out1,  -- ufix1 [16]
              ldpc_data_in => Delay20_out1,
              ldpc_ctrl_in_start => Delay18_out1_start,
              ldpc_ctrl_in_valid => Delay18_out1_valid,
              ldpc_next_frame_in => Delay17_out1,
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay18_out1_valid <= '0';
      ELSIF enb = '1' THEN
        Delay18_out1_valid <= LDPC_shared_out3_valid;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay18_out1_start <= '0';
      ELSIF enb = '1' THEN
        Delay18_out1_start <= LDPC_shared_out3_start;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay10_out1 <= Rate_Transition3_out1;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay23_reg(0) <= prepare_payload_data_out3;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay22_reg(0) <= valid_payload_to_ldpc;
  ...
  y <= unsigned(batid_to_bits_per_subcarrier_out1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay19_out1_valid <= '0';
      ELSIF enb = '1' THEN
        Delay19_out1_valid <= LDPC_shared_out2_valid;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay19_out1_end <= '0';
      ELSIF enb = '1' THEN
        Delay19_out1_end <= LDPC_shared_out2_end;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay19_out1_start <= '0';
      ELSIF enb = '1' THEN
        Delay19_out1_start <= LDPC_shared_out2_start;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay12_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay12_out1 <= header_clock_x2_out2;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay13_out1_valid <= '0';
      ELSIF enb = '1' THEN
        Delay13_out1_valid <= rx_payload_full_out7_valid;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay13_out1_end <= '0';
      ELSIF enb = '1' THEN
        Delay13_out1_end <= rx_payload_full_out7_end;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay13_out1_start <= '0';
      ELSIF enb = '1' THEN
        Delay13_out1_start <= rx_payload_full_out7_start;
      END IF;
    END IF;
  END PROCESS c_8_process;


  rx_payload_full_out6_signed <= signed(rx_payload_full_out6);

  Delay14_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay14_out1 <= to_signed(16#0#, 4);
      ELSIF enb = '1' THEN
        Delay14_out1 <= rx_payload_full_out6_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay15_out1_valid <= '0';
      ELSIF enb = '1' THEN
        Delay15_out1_valid <= h_rx_full_out15_valid;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay15_out1_end <= '0';
      ELSIF enb = '1' THEN
        Delay15_out1_end <= h_rx_full_out15_end;
      END IF;
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay15_out1_start <= '0';
      ELSIF enb = '1' THEN
        Delay15_out1_start <= h_rx_full_out15_start;
      END IF;
    END IF;
  END PROCESS c_11_process;


  h_rx_full_out14_signed <= signed(h_rx_full_out14);

  Delay16_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay16_out1 <= to_signed(16#0#, 4);
      ELSIF enb = '1' THEN
        Delay16_out1 <= h_rx_full_out14_signed;
      END IF;
    END IF;
  ...
  prepare_payload_data_out1_signed <= signed(prepare_payload_data_out1);

  Delay21_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay21_reg <= (OTHERS => to_signed(16#0#, 4));
      ELSIF enb = '1' THEN
        Delay21_reg(0) <= prepare_payload_data_out1_signed;
