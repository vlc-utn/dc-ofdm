...
BEGIN
  ...
  embreciprocals_c3_sIPrMda7O1nQeLVlY0jQLiF_positiveRealNormalize_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      END IF;
    END IF;
  END PROCESS embreciprocals_c3_sIPrMda7O1nQeLVlY0jQLiF_positiveRealNormalize_process;

  embreciprocals_c3_sIPrMda7O1nQeLVlY0jQLiF_positiveRealNormalize_output : PROCESS (isNegativeReg, tReg, u_signed, validIn, validReg, xReg)
  ...
  BEGIN
    ...
    validOut <= validReg(5);
  END PROCESS embreciprocals_c3_sIPrMda7O1nQeLVlY0jQLiF_positiveRealNormalize_output;
