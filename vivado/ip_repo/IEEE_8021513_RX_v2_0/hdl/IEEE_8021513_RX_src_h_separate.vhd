...
ARCHITECTURE rtl OF IEEE_8021513_RX_src_h_separate IS
  ...
  SIGNAL Delay3_out1                      : std_logic_vector(7 DOWNTO 0);  -- boolean [8]
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        Delay4_out1 <= '0';
      ELSIF enb_1_8_0 = '1' THEN
        Delay4_out1 <= Deserializer1D_out2;
      END IF;
    END IF;
  ...
  count_2 <= count WHEN Delay4_out1 = '0' ELSE
      count_1;

  
  count_3 <= count_2 WHEN Delay5_out1 = '0' ELSE
      count_reset;
  ...
  Vector_Concatenate_out1_gen2: FOR idx0 IN 0 TO 7 GENERATE
    Vector_Concatenate_out1(idx0 + 16) <= Delay3_out1(idx0);
  END GENERATE;
  ...
  Vector_Concatenate1_out1_gen1: FOR idx0 IN 0 TO 7 GENERATE
    Vector_Concatenate1_out1(idx0 + 8) <= Delay3_out1(idx0);
  END GENERATE;
  ...
  Vector_Concatenate2_out1(0) <= Delay3_out1(0);
  Vector_Concatenate2_out1(1) <= Delay3_out1(1);
  ...
  Vector_Concatenate3_out1(0) <= Delay3_out1(2);
  Vector_Concatenate3_out1(1) <= Delay3_out1(3);
  Vector_Concatenate3_out1(2) <= Delay3_out1(4);
  ...
  Vector_Concatenate4_out1(0) <= Delay3_out1(5);
  Vector_Concatenate4_out1(1) <= Delay3_out1(6);
  Vector_Concatenate4_out1(2) <= Delay3_out1(7);
  ...
  Vector_Concatenate5_out1(0) <= Delay3_out1(0);
  Vector_Concatenate5_out1(1) <= Delay3_out1(1);
  Vector_Concatenate5_out1(2) <= Delay3_out1(2);
  ...
  Vector_Concatenate6_out1(0) <= Delay3_out1(3);
  Vector_Concatenate6_out1(1) <= Delay3_out1(4);
  Vector_Concatenate6_out1(2) <= Delay3_out1(5);
  Vector_Concatenate6_out1(3) <= Delay3_out1(6);
  ...
  Vector_Concatenate7_out1(0) <= Delay3_out1(0);
  Vector_Concatenate7_out1(1) <= Delay3_out1(1);
  Vector_Concatenate7_out1(2) <= Delay3_out1(2);
  Vector_Concatenate7_out1(3) <= Delay3_out1(3);
  Vector_Concatenate7_out1(4) <= Delay3_out1(4);
  ...
  Vector_Concatenate8_out1(0) <= Delay3_out1(0);
  Vector_Concatenate8_out1(1) <= Delay3_out1(1);
  Vector_Concatenate8_out1(2) <= Delay3_out1(2);
  ...
  Vector_Concatenate9_out1(0) <= Delay3_out1(3);
  Vector_Concatenate9_out1(1) <= Delay3_out1(4);
  Vector_Concatenate9_out1(2) <= Delay3_out1(5);
  ...
  Vector_Concatenate10_out1(0) <= Delay3_out1(2);
  Vector_Concatenate10_out1(1) <= Delay3_out1(3);
  Vector_Concatenate10_out1(2) <= Delay3_out1(4);
  ...
  Logical_Operator_out1 <= Compare_To_Constant6_out1 OR Delay5_out1;
