...
BEGIN
  ...
  Constant4_out1 <= to_unsigned(16#29#, 6);

  Constant3_out1 <= to_unsigned(16#28#, 6);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0_gated_5 = '1' THEN
        Delay7_reg_im(0) <= data_im_signed;
        Delay7_reg_im(1) <= Delay7_reg_im(0);
        Delay7_reg_re(0) <= data_re_signed;
