...
ARCHITECTURE rtl OF IEEE_8021513_TX_src_ofdm_ready_truncate IS
  ...
  COMPONENT IEEE_8021513_TX_src_rising_edge_detector_block4
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  FOR ALL : IEEE_8021513_TX_src_rising_edge_detector_block4
    USE ENTITY work.IEEE_8021513_TX_src_rising_edge_detector_block4(rtl);
...
BEGIN
  u_rising_edge_detector : IEEE_8021513_TX_src_rising_edge_detector_block4
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              In_rsvd => next_frame,
