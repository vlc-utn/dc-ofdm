...
-- -------------------------------------------------------------
-- data_out                      ce_out        8e-09
-- valid_out                     ce_out        8e-09
-- new_msg_ready                 ce_out        8e-09
-- ready                         ce_out        8e-09
-- debug_payload                 ce_out        8e-09
-- debug_payload_ctrl_start      ce_out        8e-09
-- debug_payload_ctrl_end        ce_out        8e-09
-- debug_payload_ctrl_valid      ce_out        8e-09
-- -------------------------------------------------------------
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF IEEE_8021513_TX_src_full_tx IS
  ...
  SIGNAL Tapped_Delay_out1                : std_logic_vector(1 DOWNTO 0);  -- boolean [2]
  ...
  SIGNAL clock_crossing_out5              : std_logic_vector(1 DOWNTO 0);  -- boolean [2]
  SIGNAL clock_crossing_out6              : std_logic;
  SIGNAL clock_crossing_out7              : std_logic_vector(1 DOWNTO 0);  -- boolean [2]
  ...
  SIGNAL ofdm_ready                       : std_logic;
  SIGNAL store_frame_in_ram_out1          : std_logic_vector(1 DOWNTO 0);  -- ufix2
...
BEGIN
  ...
  u_clock_crossing : IEEE_8021513_TX_src_clock_crossing
    PORT MAP( clk => clk,
              ...
              header_out => clock_crossing_out5,  -- boolean [2]
              header_valid => clock_crossing_out6,
              payload_out => clock_crossing_out7,  -- boolean [2]
  ...
  u_store_frame_in_ram : IEEE_8021513_TX_src_store_frame_in_ram
    PORT MAP( clk => clk,
              ...
              ready => ofdm_ready,
              data_out => store_frame_in_ram_out1,  -- ufix2
  ...
  u_full_ofdm_modulator : IEEE_8021513_TX_src_full_ofdm_modulator
    PORT MAP( clk => clk,
              ...
              enb_1_2_0 => enb_1_2_0,
              enb => enb,
              data_in => store_frame_in_ram_out1,  -- ufix2
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Tapped_Delay_out1(0) <= Tapped_Delay_out1(1);
        Tapped_Delay_out1(1) <= aa;
      END IF;
    END IF;
  ...
  Bitwise_Operator_out1 <= Tapped_Delay_out1_0 OR Tapped_Delay_out1_1;
  ...
  end_rsvd_1 <= channel_gen_out2_end;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        Rate_Transition1_out1 <= end_rsvd_1;
      END IF;
    END IF;
  ...
  end_rsvd_2 <= header_full_out2_end;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        Delay13_reg(1 DOWNTO 0) <= clock_crossing_out5(1 DOWNTO 0);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_2_0 = '1' THEN
        Delay11_reg(1 DOWNTO 0) <= clock_crossing_out7(1 DOWNTO 0);
  ...
  data_out <= std_logic_vector(ip_to_dac_out1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        delayMatch9_reg(0) <= payload_full_out3;
        delayMatch9_reg(1) <= delayMatch9_reg(0);
      END IF;
    END IF;
  END PROCESS delayMatch9_process;

  payload_full_out3_1 <= delayMatch9_reg(1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        delayMatch10_reg(0) <= payload_full_out1;
        delayMatch10_reg(1) <= delayMatch10_reg(0);
      END IF;
    END IF;
  END PROCESS delayMatch10_process;

  payload_full_out1_1 <= delayMatch10_reg(1);
  ...
  payload_ctrl_out_start_1 <= alpha_reg(1);
  ...
  payload_ctrl_out_end_1 <= alpha_reg_1(1);
  ...
  payload_ctrl_out_valid_1 <= alpha_reg_2(1);

  ce_out <= enb_1_1_1;

  valid_out <= valid_out_1;

  new_msg_ready <= signal_out;
