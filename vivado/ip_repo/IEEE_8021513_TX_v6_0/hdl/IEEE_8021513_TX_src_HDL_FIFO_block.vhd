-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLTx/IEEE_8021513_TX_src_HDL_FIFO_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: IEEE_8021513_TX_src_HDL_FIFO_block
-- Source Path: HDLTx/full_tx/full_ofdm_modulator/HDL_FIFO
-- Hierarchy Level: 2
-- Model version: 4.222
-- 
-- -------------------------------------------------------------
...
ENTITY IEEE_8021513_TX_src_HDL_FIFO_block IS
...
END IEEE_8021513_TX_src_HDL_FIFO_block;


ARCHITECTURE rtl OF IEEE_8021513_TX_src_HDL_FIFO_block IS
  ...
  SIGNAL w_num                            : unsigned(11 DOWNTO 0);  -- ufix12
...
BEGIN
  ...
  u_HDL_FIFO_ram_generic : IEEE_8021513_TX_src_SimpleDualPortRAM_generic_block1
  ...
  fifo_out4 <= '1' WHEN fifo_sample_count = to_unsigned(16#A00#, 12) ELSE
      '0';
  ...
  fifo_front_dir_next <= to_unsigned(16#601#, 12) WHEN fifo_front_indx_temp = to_unsigned(16#9FF#, 12) ELSE
  ...
  fifo_back_dir_next <= to_unsigned(16#601#, 12) WHEN fifo_back_indx_temp = to_unsigned(16#9FF#, 12) ELSE
      to_unsigned(16#001#, 12);
  ...
  w_cz <= '1' WHEN w_num > to_unsigned(16#000#, 12) ELSE
      '0';
