...
ARCHITECTURE rtl OF IEEE_8021513_TX_src_full_ofdm_modulator IS
  ...
  COMPONENT IEEE_8021513_TX_src_HDL_FIFO_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  FOR ALL : IEEE_8021513_TX_src_HDL_FIFO_block
    USE ENTITY work.IEEE_8021513_TX_src_HDL_FIFO_block(rtl);
...
BEGIN
  ...
  u_HDL_FIFO : IEEE_8021513_TX_src_HDL_FIFO_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
