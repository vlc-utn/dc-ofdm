...
ARCHITECTURE rtl OF IEEE_8021513_TX_src_FIRFilter1 IS
  ...
  SIGNAL preAddIn                         : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL coeffTableReg7_1                 : signed(19 DOWNTO 0);  -- sfix20_En16
  ...
  SIGNAL coeffTableReg6_1                 : signed(19 DOWNTO 0);  -- sfix20_En16
  ...
  SIGNAL delayLineEnd14deadOut            : std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  SIGNAL sumOut_6_signed                  : signed(32 DOWNTO 0);  -- sfix33_En30
  ...
  SIGNAL preAddIn_1                       : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL coeffTableReg7_3                 : signed(19 DOWNTO 0);  -- sfix20_En16
  ...
  SIGNAL coeffTableReg6_3                 : signed(19 DOWNTO 0);  -- sfix20_En16
  ...
  SIGNAL delayLineEnd14deadOut_1          : std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  SIGNAL sumOut_6_signed_1                : signed(32 DOWNTO 0);  -- sfix33_En30
...
BEGIN
  ...
  u_delayLine5 : IEEE_8021513_TX_src_Addressable_Delay_Line
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine6 : IEEE_8021513_TX_src_Addressable_Delay_Line_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine7 : IEEE_8021513_TX_src_Addressable_Delay_Line_block1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine9 : IEEE_8021513_TX_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine10 : IEEE_8021513_TX_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine11 : IEEE_8021513_TX_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine12 : IEEE_8021513_TX_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => delayLineEnd11,  -- sfix16_En14
  ...
  u_delayLine13 : IEEE_8021513_TX_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => delayLineEnd12,  -- sfix16_En14
  ...
  u_delayLine14 : IEEE_8021513_TX_src_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => delayLineEnd13,  -- sfix16_En14
              validIn => delayLineShiftEn1_1,
              rdAddr => rdAddr1,  -- ufix1
              delayLineEnd => delayLineEnd14deadOut,  -- sfix16_En14
  ...
  u_filterTap0 : IEEE_8021513_TX_src_FilterTapSystolicPreAdd
    PORT MAP( clk => clk,
              ...
              preAddIn => delayLineDataOut14,  -- sfix16_En14
  ...
  u_filterTap1 : IEEE_8021513_TX_src_FilterTapSystolicPreAdd
    PORT MAP( clk => clk,
              ...
              preAddIn => delayLineDataOut13,  -- sfix16_En14
  ...
  u_filterTap2 : IEEE_8021513_TX_src_FilterTapSystolicPreAdd
    PORT MAP( clk => clk,
              ...
              preAddIn => delayLineDataOut12,  -- sfix16_En14
  ...
  u_filterTap6 : IEEE_8021513_TX_src_FilterTapSystolicPreAdd
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_re => delayLineDataOut6,  -- sfix16_En14
              preAddIn => delayLineDataOut8,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableReg6_1),  -- sfix20_En16
              sumIn => sumOut_4,  -- sfix33_En30
              sumOut => sumOut_5  -- sfix33_En30
              );

  u_filterTap7 : IEEE_8021513_TX_src_FilterTapSystolicPreAdd
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_re => delayLineDataOut7,  -- sfix16_En14
              preAddIn => std_logic_vector(preAddIn),  -- sfix16_En14
              coeff => std_logic_vector(coeffTableReg7_1),  -- sfix20_En16
              sumIn => sumOut_5,  -- sfix33_En30
              sumOut => sumOut_6  -- sfix33_En30
              );

  u_delayLine0_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block4
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine1_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block4
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine2_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block4
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine3_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block4
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine4_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block4
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine8_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block7
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine11_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine12_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => delayLineEnd11_1,  -- sfix16_En14
              validIn => delayLineShiftEn3_1,
              rdAddr => rdAddr3,  -- ufix1
  ...
  u_delayLine13_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => delayLineEnd12_1,  -- sfix16_En14
              validIn => delayLineShiftEn2_1,
              rdAddr => rdAddr2,  -- ufix1
  ...
  u_delayLine14_1 : IEEE_8021513_TX_src_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => delayLineEnd13_1,  -- sfix16_En14
              validIn => delayLineShiftEn1_1,
              rdAddr => rdAddr1,  -- ufix1
              delayLineEnd => delayLineEnd14deadOut_1,  -- sfix16_En14
  ...
  u_filterTap0_1 : IEEE_8021513_TX_src_FilterTapSystolicPreAdd_block
    PORT MAP( clk => clk,
              ...
              preAddIn => delayLineDataOut14_1,  -- sfix16_En14
  ...
  u_filterTap1_1 : IEEE_8021513_TX_src_FilterTapSystolicPreAdd_block
    PORT MAP( clk => clk,
              ...
              preAddIn => delayLineDataOut13_1,  -- sfix16_En14
  ...
  u_filterTap2_1 : IEEE_8021513_TX_src_FilterTapSystolicPreAdd_block
    PORT MAP( clk => clk,
              ...
              preAddIn => delayLineDataOut12_1,  -- sfix16_En14
  ...
  u_filterTap6_1 : IEEE_8021513_TX_src_FilterTapSystolicPreAdd_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_im => delayLineDataOut6_1,  -- sfix16_En14
              preAddIn => delayLineDataOut8_1,  -- sfix16_En14
              coeff => std_logic_vector(coeffTableReg6_3),  -- sfix20_En16
              sumIn => sumOut_4_1,  -- sfix33_En30
              sumOut => sumOut_5_1  -- sfix33_En30
              );

  u_filterTap7_1 : IEEE_8021513_TX_src_FilterTapSystolicPreAdd_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              din_im => delayLineDataOut7_1,  -- sfix16_En14
              preAddIn => std_logic_vector(preAddIn_1),  -- sfix16_En14
              coeff => std_logic_vector(coeffTableReg7_3),  -- sfix20_En16
  ...
  BEGIN
    CASE rdAddr7 IS
      WHEN '0' =>
        coeffTableOut7 <= to_signed(16#0D3F3#, 20);
      WHEN '1' =>
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        coeffTableReg7_1 <= to_signed(16#00000#, 20);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    CASE rdAddr6 IS
      WHEN '0' =>
        coeffTableOut6 <= to_signed(16#02945#, 20);
      WHEN '1' =>
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        coeffTableReg6_1 <= to_signed(16#00000#, 20);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    CASE rdAddr5 IS
      WHEN '0' =>
        coeffTableOut5 <= to_signed(16#01769#, 20);
      WHEN '1' =>
        coeffTableOut5 <= to_signed(-16#021B5#, 20);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr4 IS
      WHEN '0' =>
        coeffTableOut4 <= to_signed(16#00471#, 20);
      WHEN '1' =>
        coeffTableOut4 <= to_signed(-16#00CEF#, 20);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr3 IS
      WHEN '0' =>
        coeffTableOut3 <= to_signed(-16#00323#, 20);
      WHEN '1' =>
        coeffTableOut3 <= to_signed(16#000E9#, 20);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr2 IS
      WHEN '0' =>
        coeffTableOut2 <= to_signed(-16#00206#, 20);
      WHEN '1' =>
        coeffTableOut2 <= to_signed(16#0031D#, 20);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr1 IS
      WHEN '0' =>
        coeffTableOut1 <= to_signed(-16#0001E#, 20);
      WHEN '1' =>
        coeffTableOut1 <= to_signed(16#000D6#, 20);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr0_1 IS
      WHEN '0' =>
        coeffTableOut0 <= to_signed(16#00018#, 20);
      WHEN '1' =>
        coeffTableOut0 <= to_signed(-16#0003C#, 20);
      WHEN OTHERS => 
  ...
  sumOut_6_signed <= signed(sumOut_6);
  ...
  preAddIn_1 <= to_signed(16#0000#, 16);
  ...
  BEGIN
    CASE rdAddr7 IS
      WHEN '0' =>
        coeffTableOut7_1 <= to_signed(16#0D3F3#, 20);
      WHEN '1' =>
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        coeffTableReg7_3 <= to_signed(16#00000#, 20);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    CASE rdAddr6 IS
      WHEN '0' =>
        coeffTableOut6_1 <= to_signed(16#02945#, 20);
      WHEN '1' =>
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        coeffTableReg6_3 <= to_signed(16#00000#, 20);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    CASE rdAddr5 IS
      WHEN '0' =>
        coeffTableOut5_1 <= to_signed(16#01769#, 20);
      WHEN '1' =>
        coeffTableOut5_1 <= to_signed(-16#021B5#, 20);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr4 IS
      WHEN '0' =>
        coeffTableOut4_1 <= to_signed(16#00471#, 20);
      WHEN '1' =>
        coeffTableOut4_1 <= to_signed(-16#00CEF#, 20);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr3 IS
      WHEN '0' =>
        coeffTableOut3_1 <= to_signed(-16#00323#, 20);
      WHEN '1' =>
        coeffTableOut3_1 <= to_signed(16#000E9#, 20);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr2 IS
      WHEN '0' =>
        coeffTableOut2_1 <= to_signed(-16#00206#, 20);
      WHEN '1' =>
        coeffTableOut2_1 <= to_signed(16#0031D#, 20);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr1 IS
      WHEN '0' =>
        coeffTableOut1_1 <= to_signed(-16#0001E#, 20);
      WHEN '1' =>
        coeffTableOut1_1 <= to_signed(16#000D6#, 20);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr0_1 IS
      WHEN '0' =>
        coeffTableOut0_1 <= to_signed(16#00018#, 20);
      WHEN '1' =>
        coeffTableOut0_1 <= to_signed(-16#0003C#, 20);
      WHEN OTHERS => 
  ...
  sumOut_6_signed_1 <= signed(sumOut_6_1);
